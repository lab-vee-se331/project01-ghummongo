...
<template>
  <main class="h-full grid grid-cols-12 gap-4 content-center">
    <div class="col-span-12 lg:col-span-4 bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
      <img
        class="w-32 h-32 rounded-full mx-auto"
        src="https://i.imgur.com/tbXDnsJ.jpg"
        alt="Profile picture"
      />
      <h2 class="text-center text-2xl font-semibold mt-3">Web</h2>
      <p class="text-center text-gray-600 mt-1">Software Engineer</p>
      <div class="mt-5">
        <h3 class="text-xl font-semibold">Bio</h3>
        <p class="text-gray-600 mt-2">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis labore iusto a sunt et nesciunt voluptates magni, perspiciatis beatae autem.
        </p>
      </div>
    </div>
