            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
              <div class="md:col-span-6">
                ...
                <input
                  ...
                  type="file" id="formFile" accept="image/png, image/gif, image/jpeg" @change="uploadImage" />
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" name="studentId" id="studentId" v-model="student.studentId"
                  class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="e.g. 642115069" />
                <p v-if="errors.studentId" class="error">{{ errors.studentId }}</p>
              </div>
              <div class="md:col-span-2">
                <label for="courses">Courses</label>
              ...
              <div class="md:col-span-6">
                ...
                <textarea type="text" name="comment" id="comment" v-model="student.comment"
                  class="h-20 border mt-1 rounded px-4 pt-2 w-full bg-gray-50" placeholder="e.g. Noob shit" />
