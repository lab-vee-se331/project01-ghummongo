      ...
      <div class="col-span-4">
        ...
        <div class="pt-2 w-fit">
          <div class="flex flex-col pl-6 text-gray-500 border-l border-gray-300">
            <div v-if="comment?.reply?.content" class="grid grid-cols-6 mb-2">
              ...
              <div class="col-span-5">
                <div class="text-gray-600">
                  <span class="font-bold">{{ oneStudent.firstname }} (Student)</span> · 1h ago
                </div>
            ...
            >
              <font-awesome-icon icon="reply" class="mr-2" /><span class="group-hover:underline">{{
                replyStates[comment.id] ? 'Hide' : 'Reply'
              }}</span>
            </p>
